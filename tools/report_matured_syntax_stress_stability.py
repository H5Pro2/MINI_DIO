...
def main() -> None:
    ...
    parser.add_argument("--matured", default="docs/befunde/2001-3000/2052_PASSIVE_REIFESPUR_NACHGEREIFTER_SYNTAXINSELN.families.csv")
    parser.add_argument("--stress-bridge", default="docs/befunde/2001-3000/2053_STRESSWELTEN_FELDKLASSEN_ZU_SYNTAXNAEHE.bridge.csv")

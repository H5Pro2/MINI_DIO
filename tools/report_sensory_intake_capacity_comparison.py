...
INPUT_DEFAULT = Path("docs/befunde/100-1000/100-500/404_SINNESACHSEN_EPISODENKARTE_GEGENPROBE.csv")
CSV_DEFAULT = Path("docs/befunde/100-1000/100-500/407_SINNESAUFNAHME_FAEHIGKEITSVERGLEICH.csv")
MD_DEFAULT = Path("docs/befunde/100-1000/100-500/407_SINNESAUFNAHME_FAEHIGKEITSVERGLEICH.md")

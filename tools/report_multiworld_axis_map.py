...
def main() -> int:
    ...
    parser.add_argument("--out", default="docs/befunde/1001-2000/1501-1750/1674_AUTOMATISIERTER_MEHRWELT_ACHSENREPORT.md")
    parser.add_argument("--csv", default="docs/befunde/1001-2000/1501-1750/1674_AUTOMATISIERTER_MEHRWELT_ACHSENREPORT.csv")

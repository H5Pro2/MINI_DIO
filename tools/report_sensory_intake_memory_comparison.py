...
BASE_DEFAULT = Path("docs/befunde/100-1000/100-500/409_PASSIVE_SINNESAUFNAHME_MEMORY.csv")
PROBE_DEFAULT = Path("docs/befunde/100-1000/100-500/412_BTC2024_5M_QUIET_PASSIVE_SINNESAUFNAHME_MEMORY.csv")
CSV_DEFAULT = Path("docs/befunde/100-1000/100-500/413_BTC2024_5M_QUIET_INTAKE_MEMORY_ABGLEICH.csv")
MD_DEFAULT = Path("docs/befunde/100-1000/100-500/413_BTC2024_5M_QUIET_INTAKE_MEMORY_ABGLEICH.md")

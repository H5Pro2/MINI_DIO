...
CSV_DEFAULT = Path("docs/befunde/100-1000/100-500/406_HOEREN_HIN_REKOPPLUNGSFAEHIGKEIT.csv")
MD_DEFAULT = Path("docs/befunde/100-1000/100-500/406_HOEREN_HIN_REKOPPLUNGSFAEHIGKEIT.md")

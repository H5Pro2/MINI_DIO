...
DEFAULT_INPUT = befunde_root(ROOT) / "1257_MCM_FELDPHASEN_ROHWELT_FENSTERLUPE_ERWEITERT.csv"
DEFAULT_OUT = befunde_root(ROOT) / "1260_MCM_BEWEGUNGSBRUCH_FOLGEFORMEN.md"

...
DEFAULT_INPUTS = [
    befunde_root(ROOT) / "459_PASSIVE_REGULATIONSVORSCHLAG_BASIS.csv",
    befunde_root(ROOT) / "460_BTC2024_5M_QUIET_REGULATIONSVORSCHLAG.csv",
    befunde_root(ROOT) / "461_BTC2024_5M_STRESS_REGULATIONSVORSCHLAG.csv",
    befunde_root(ROOT) / "462_BTC2024_1H_QUIET_REGULATIONSVORSCHLAG.csv",
    befunde_root(ROOT) / "463_BTC2024_1H_STRESS_REGULATIONSVORSCHLAG.csv",
    befunde_root(ROOT) / "465_SOL2023_NEGATIVE_STRESS_10K_REGULATIONSVORSCHLAG.csv",
    befunde_root(ROOT) / "466_SOL2026_SIDEWAYS_10K_REGULATIONSVORSCHLAG.csv",
    befunde_root(ROOT) / "467_SOL2023_POSITIVE_EXPANSION_10K_REGULATIONSVORSCHLAG.csv",
    befunde_root(ROOT) / "471_KAS2024_ZEITEBENEN_REGULATIONSVORSCHLAG.csv",
]
CSV_DEFAULT = befunde_root(ROOT) / "473_PASSIVE_REGULATIONSVORSCHLAG_FELDTRAGUNG.csv"
MD_DEFAULT = befunde_root(ROOT) / "473_PASSIVE_REGULATIONSVORSCHLAG_FELDTRAGUNG.md"

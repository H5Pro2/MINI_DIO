...
CSV_DEFAULT = Path("docs/befunde/100-1000/100-500/408_SINNESAUFNAHME_WIEDERERKENNUNG.csv")
MD_DEFAULT = Path("docs/befunde/100-1000/100-500/408_SINNESAUFNAHME_WIEDERERKENNUNG.md")

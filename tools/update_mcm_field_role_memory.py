...
WORLD_FIT_SOURCES = [
    ...
    ROOT / "docs/befunde/1903_DOGE_GEOEFFNET_WIEDERKEHR.csv",
    ROOT / "docs/befunde/1908_SYNTHETISCHE_WELTPASSUNG_KONTROLLWELTEN.csv",
    ROOT / "docs/befunde/1913_WEICHE_SYNTHETISCHE_WELTPASSUNG.csv",
    ROOT / "docs/befunde/1928_B_FOCUS_HARTKERNBRILLEN_WELTPASSUNG_KORREKT.csv",
    ROOT / "docs/befunde/1941_B_FOCUS_NACHBARFENSTER_WELTPASSUNG.csv",
]

...
INPUT_DEFAULT = Path("docs/befunde/100-1000/100-500/402_LOKALE_SINNESACHSEN_EPISODENKARTE.csv")
CSV_DEFAULT = Path("docs/befunde/100-1000/100-500/403_SINNESACHSEN_REKOPPLUNGSQUALITAET.csv")
MD_DEFAULT = Path("docs/befunde/100-1000/100-500/403_SINNESACHSEN_REKOPPLUNGSQUALITAET.md")

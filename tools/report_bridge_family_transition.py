...
CSV_DEFAULT = befunde_root(ROOT) / "817_BLOCK_K_BRUECKENFAMILIE_UEBERGANGSSTRUKTUR.csv"
MD_DEFAULT = befunde_root(ROOT) / "817_BLOCK_K_BRUECKENFAMILIE_UEBERGANGSSTRUKTUR.md"

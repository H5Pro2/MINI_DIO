...
- gleiche Welt: `True`
- Real A Memory: `memory\real_sleep_real\synth_rand_kipp_start250_size1650_rolling_method_probe\memory_A_real_run.json`
- Sleep Diagnose: `debug\real_sleep_real\synth_rand_kipp_start250_size1650_rolling_method_probe\sleep`
- Memory nach Sleep: `memory\real_sleep_real\synth_rand_kipp_start250_size1650_rolling_method_probe\memory_A_after_sleep.json`
- Real B Memory: `memory\real_sleep_real\synth_rand_kipp_start250_size1650_rolling_method_probe\memory_B_real_run_after_sleep.json`
...
- MCM-Tragqualitaet: `0.55831` -> `0.558557`
- MCM-Rekopplung: `0.722131` -> `0.721865`
- MCM-Sinneskopplung: `0.872669` -> `0.872426`

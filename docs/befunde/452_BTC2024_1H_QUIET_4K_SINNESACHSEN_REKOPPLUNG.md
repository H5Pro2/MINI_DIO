# 452 - Sinnesachsen-Rekopplungsqualitaet
...
|---|---:|---:|---:|---:|---:|
| BTC_2024_1H_QUIET_4K | hoeren_hin | ruhig_rekoppelnd | 0.5721 | fuehlen_abstand 0.2277 | feldinput 0.2556 |

## Achsenbefund

- `hoeren_hin`: mittlere Rekopplung 0.7216, mittlerer Strain 0.1341.
- `sehen_fokus`: mittlere Rekopplung 0.7136, mittlerer Strain 0.1401.
- `feldinput`: mittlere Rekopplung 0.6616, mittlerer Strain 0.2039, mittlerer Feldinput 0.2556.

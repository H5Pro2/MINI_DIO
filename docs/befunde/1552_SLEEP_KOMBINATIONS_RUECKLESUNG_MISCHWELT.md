...
- Real B Welt: `data\synthetic_1525_melody_randrollen_interwoven_mosaic_2400_5m.csv`
- gleiche Welt: `False`
- Real A Memory: `memory\real_sleep_real\sol2024_sleep_combo_mosaic1525\memory_A_real_run.json`
- Sleep Diagnose: `debug\real_sleep_real\sol2024_sleep_combo_mosaic1525\sleep`
- Memory nach Sleep: `memory\real_sleep_real\sol2024_sleep_combo_mosaic1525\memory_A_after_sleep.json`
- Real B Memory: `memory\real_sleep_real\sol2024_sleep_combo_mosaic1525\memory_B_real_run_after_sleep.json`

## Real A -> Real B

- Episoden: `1994.0` -> `2394.0`
- Unique Syntax: `351.0` -> `97.0`
- geschriebene Feldepisoden: `5.0` -> `2.0`
- MCM-Tragqualitaet: `0.509901` -> `0.557258`
- MCM-Rekopplung: `0.693318` -> `0.720689`
- MCM-Sinneskopplung: `0.83793` -> `0.865664`
- Top-Syntax-Ueberlappung: `0.230769`
- Top-Familien-Ueberlappung: `0.454545`
...
- Sleep-Rollen-Reaktivierung: `0` / `3`
- Sleep-Kombinationen voll reaktiviert: `0` / `3`

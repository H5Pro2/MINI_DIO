# 1926 - BTC B Fokus 2400 3900 Repro
...
- Folgefenster: `docs\befunde\1924_BTC_B_FOCUS_2400_3900.csv`.
...
- Repro-Zustände: `fehlt_im_folgefenster:637; lokale_qualitaet_wird_offen:6; lokale_qualitaet_reproduziert:3; lokale_qualitaet_wird_kernnah:1; lokale_qualitaet_driftet:1; lokale_qualitaet_wird_nachhallnah:1; lokale_qualitaet_wird_nullnah:1; qualitaet_reproduziert:1`
- Baseline-Zustände: `phasenlokal_eigenstaendig:446; geteilt_offen:101; einzelbeleg:57; fenstergetragen_stabil:47`
- Eigenständige Baseline-Familien: `fehlt_im_folgefenster:434; lokale_qualitaet_wird_offen:5; lokale_qualitaet_reproduziert:3; lokale_qualitaet_wird_kernnah:1; lokale_qualitaet_driftet:1; lokale_qualitaet_wird_nachhallnah:1; lokale_qualitaet_wird_nullnah:1`
- Asset-Profil: `PAXG::fehlt_im_folgefenster:135; SOL::fehlt_im_folgefenster:135; XRP::fehlt_im_folgefenster:135; DOGE::fehlt_im_folgefenster:120; BTC::fehlt_im_folgefenster:112; BTC::lokale_qualitaet_wird_offen:6; BTC::lokale_qualitaet_reproduziert:3; BTC::lokale_qualitaet_wird_kernnah:1; BTC::lokale_qualitaet_driftet:1; BTC::lokale_qualitaet_wird_nachhallnah:1; BTC::lokale_qualitaet_wird_nullnah:1; BTC::qualitaet_reproduziert:1`
...
| `lokale_qualitaet_reproduziert` | 3 | 0.005 |
...
| BTC | `dio_14wj` | `mitte` | `phase_nullnah` | `phase_nullnah` | `lokale_qualitaet_reproduziert` | `phase_nullnah:5; phase_offen_gemischt:1` | `phase_nullnah:1` |
| BTC | `dio_00ja` | `frueh` | `phase_nullnah` | `fehlt` | `fehlt_im_folgefenster` | `phase_nullnah:3; phase_offen_gemischt:2; phase_kernnah:1` | `` |
| BTC | `dio_00ly` | `frueh` | `phase_nullnah` | `phase_ohne_nullfamilie` | `lokale_qualitaet_driftet` | `phase_nullnah:4; phase_offen_gemischt:2` | `phase_ohne_nullfamilie:1` |
...
| BTC | `dio_06er` | `mitte` | `phase_nullnah` | `phase_offen_gemischt` | `lokale_qualitaet_wird_offen` | `phase_nullnah:4; phase_nachhallnah_ohne_kern:2` | `phase_offen_gemischt:1` |
| BTC | `dio_06er` | `spaet` | `phase_nullnah` | `phase_offen_gemischt` | `lokale_qualitaet_wird_offen` | `phase_nullnah:3; phase_nachhallnah_ohne_kern:2; phase_offen_gemischt:1` | `phase_offen_gemischt:1` |
...
| BTC | `dio_09bn` | `frueh` | `phase_nullnah` | `phase_offen_gemischt` | `lokale_qualitaet_wird_offen` | `phase_nullnah:6` | `phase_offen_gemischt:1` |
...
| BTC | `dio_0g2r` | `spaet` | `phase_offen_gemischt` | `fehlt` | `fehlt_im_folgefenster` | `phase_offen_gemischt:6` | `` |

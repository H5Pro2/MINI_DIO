# 2007_MIXED_BINDING_TRANSITION_PROBE - Passive Feldfunktions-Memory Mehrweltprüfung
...
- Memory: `memory\2007_mixed_binding_transition_probe.json`
- Preview-Anker gesamt: `512`
- Preview-Anker mit Feldfunktionslesung: `152`

## Klassen

- `active_recoupling`: `134`
- `milieu_island`: `15`
- `open_surface`: `3`

## Varianten

- `distributed_active_recoupling`: `96`

# 2007_MIXED_BINDING_PAXG_SHIFT_PROBE - Passive Feldfunktions-Memory Mehrweltprüfung
...
- Memory: `memory\2007_mixed_binding_paxg_shift_probe.json`
- Preview-Anker gesamt: `512`
- Preview-Anker mit Feldfunktionslesung: `147`

## Klassen

- `active_recoupling`: `126`
- `milieu_island`: `15`
- `open_surface`: `6`

## Varianten

- `distributed_active_recoupling`: `92`
- `compact_carried_recoupling`: `34`
- `quiet_deep_recoupling`: `13`
- `unsettled_surface_trace`: `6`
- `local_milieu_seed`: `2`

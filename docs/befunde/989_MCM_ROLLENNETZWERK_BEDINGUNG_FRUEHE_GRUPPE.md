...
|---|---:|---:|---:|---:|---|---|---|---|
| `netz_offen_verbunden` | 32 | 1.6875 | -0.044234 | 0.051729 | `role_condensing:32` | `gaining_weight:32` | `surface_role_movement:32` | Offene Verbindung zeigt Anschluss ohne klare Zentrums- oder Rekopplungsbindung. |
| `netz_fragmentiert_belastet` | 28 | 3.357143 | -0.059659 | 0.063822 | `role_drifting:12 | role_stable:10 | role_core_near_retained:6` | `stable_surface:10 | variable_but_carried:8 | stable_core:6 | gaining_weight:4` | `low_drift:16 | explicit_role_drift:12` | Fragmentierung wird belastet, wenn Strain und Aussen-/Brueckenriss trotz sichtbarer Kernnaehe hoch bleiben. |
| `netz_rekoppelnd_verbunden` | 28 | 1.607143 | 0.041417 | -0.012833 | `role_condensing:25 | maturation_jung_gehalten:1 | maturation_reifung:1 | role_releasing:1` | `gaining_weight:25 | segment_nicht_gelesen:1 | kurze_mehrweltspur:1 | losing_role_weight:1` | `surface_role_movement:25 | feld_unguelesen:1 | feld_jung_instabiler_austritt:1 | role_releasing_or_fading:1` | Rekopplung entsteht, wenn Feldanschluss und Entlastung gemeinsam staerker wirken als Strain. |
| `netz_driftend_getragen` | 22 | 2.181818 | 0.024412 | -0.013821 | `role_stable:13 | role_drifting:7 | role_core_near_retained:2` | `stable_surface:13 | variable_but_carried:6 | stable_core:2 | gaining_weight:1` | `low_drift:15 | explicit_role_drift:7` | Drift bleibt getragen, wenn Rollenbewegung sichtbar ist, aber Rekopplung Strain nicht klar unterliegt. |
| `netz_rekoppelnd_einzeln` | 17 | 0.0 | 0.0 | 0.0 | `role_releasing:17` | `losing_role_weight:17` | `role_releasing_or_fading:17` | Einzelrekopplung zeigt Entlastung ohne tragendes Nachbarschaftsnetz. |
| `netz_zentrum_mit_anschluss` | 8 | 5.625 | 0.006569 | 0.006378 | `role_condensing:4 | role_core_near_retained:3 | role_releasing:1` | `core_near_retained:7 | losing_role_weight:1` | `core_boundary_movement:7 | role_releasing_or_fading:1` | Zentrumsnaehe entsteht, wenn Kern-/Zentrumsqualitaet mit Anschlussnachbarschaft zusammen sichtbar wird. |

...
```text
docs/befunde/2009_MIXED_BINDING_POSITIVE_ZIELWELT_RAW_PHASE.csv
```
...
```text
docs/befunde/2010_POSITIVE_MIXED_BINDING_SIGNATURE_TARGET_WORLDS.md
docs/befunde/2011_POSITIVE_MIXED_BINDING_SIGNATURE_COUNTER_WORLDS.md
```

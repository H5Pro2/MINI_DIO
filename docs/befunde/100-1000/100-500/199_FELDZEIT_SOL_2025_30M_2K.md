...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| sol_2025_30m_2k | 1994 | 0.000339/0.053333 | 0.008478/0.285714 | 0.600912 | 0.343351 | 0.256522 | 433 | 1138 | 180 |
...
- Zeitstatus: `temporal_first_contact` `1899`, `temporal_far_return` `93`, `temporal_near_return` `2`
- Feldwirkung: `tragend_unruhig` `793`, `gespannt` `402`, `stabil` `396`, `kippend` `342`, `diffus` `61`

Stärkste Nachhallabschnitte:

- Abschnitt `1` (`0`-`199`): max_afterimage `0.053333`, avg_recurrence `0.000838`, dominante Wirkung `tragend_unruhig`, Memory `12`
- Abschnitt `8` (`1393`-`1592`): max_afterimage `0.046667`, avg_recurrence `0.007538`, dominante Wirkung `tragend_unruhig`, Memory `57`
- Abschnitt `10` (`1791`-`1994`): max_afterimage `0.046667`, avg_recurrence `0.012667`, dominante Wirkung `tragend_unruhig`, Memory `37`

Stärkste Wiederkehrabschnitte:

- Abschnitt `6` (`995`-`1194`): avg_recurrence `0.013161`, max_recurrence `0.285714`, dominante Zeitlage `temporal_first_contact`, dominante Formfamilie `dio_0jer` (`0.010`)
- Abschnitt `9` (`1592`-`1791`): avg_recurrence `0.012922`, max_recurrence `0.285714`, dominante Zeitlage `temporal_first_contact`, dominante Formfamilie `dio_1r0h` (`0.010`)
- Abschnitt `7` (`1194`-`1393`): avg_recurrence `0.012682`, max_recurrence `0.285714`, dominante Zeitlage `temporal_first_contact`, dominante Formfamilie `dio_1ar1` (`0.010`)

Stärkste Memoryabschnitte:

- Abschnitt `5` (`796`-`995`): memory_ratio `0.447`, Rekopplung `0.577373`, Tragqualität `0.320425`, Strain `0.304872`
- Abschnitt `6` (`995`-`1194`): memory_ratio `0.296`, Rekopplung `0.594932`, Tragqualität `0.343178`, Strain `0.274933`
- Abschnitt `8` (`1393`-`1592`): memory_ratio `0.286`, Rekopplung `0.595704`, Tragqualität `0.340154`, Strain `0.265529`

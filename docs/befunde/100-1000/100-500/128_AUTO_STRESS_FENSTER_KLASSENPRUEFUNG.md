...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Stress-Gegenpol | 3 | 0.000229/0.058947 | 0.004623/0.285714 | 0.0275 | 0.1087 | 0.5258 | 0.0516 | 0.616606 | 0.350151 | 0.220647 |
...
Die automatisch extrahierte Welt `welt_auto_stress_extreme_expansion_test1_01` fällt in den Stress-Gegenpol.
Damit bestätigt sie den vorherigen Gegenbefund: Nicht der Dateiname entscheidet über Stress, sondern die messbare Rohweltbelastung und die daraus entstehende Innenfeldreaktion.
Die Probe zeigt niedrigere Rekopplung, höhere Memorylast und mehr gespannte/kippende Feldwirkung als die ruhige Nähegruppe.

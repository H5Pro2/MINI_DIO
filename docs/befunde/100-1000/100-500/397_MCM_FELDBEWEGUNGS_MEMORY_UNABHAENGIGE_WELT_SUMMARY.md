...
- `docs\befunde\396_MCM_FELDBEWEGUNG_LATE_SHIFT_2023_PASSIVE_FELDWIRKUNG_reproduktion.csv`
...
|---|---:|---:|---|---|---|---|---|---|
| dio_mcm_episode_02xikfk->dio_mcm_episode_1t5bcxp | 1 | 1 | breit_driftend | young | young_trace | - | - | 396_MCM_FELDBEWEGUNG_LATE_SHIFT_2023_PASSIVE_FELDWIRKUNG_reproduktion.csv:1 |

## Befund

Die bisherige Verdichtung bleibt passiv:

- `dio_mcm_episode_02xikfk->dio_mcm_episode_1t5bcxp` bleibt jung: beobachtet, aber noch nicht gereift.

Wichtig: Diese Qualitaeten sind keine Regeln. Sie beschreiben gewachsene Innenfeldspuren.

## Export

- CSV: `docs\befunde\397_MCM_FELDBEWEGUNGS_MEMORY_UNABHAENGIGE_WELT_SUMMARY.csv`
- JSON: `docs\befunde\397_MCM_FELDBEWEGUNGS_MEMORY_UNABHAENGIGE_WELT_SUMMARY.json`

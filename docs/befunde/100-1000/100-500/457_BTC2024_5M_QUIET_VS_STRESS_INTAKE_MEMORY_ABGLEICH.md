# 457 - Btc2024 5M Quiet Vs Stress Intake Memory Abgleich
...
- Basis: `438_BTC2024_5M_QUIET_4K_LONG_PASSIVE_SINNESAUFNAHME_MEMORY.csv`
...
- Gemeinsame Intake-Keys: 3.
- Gleiche Memory-Qualitaet: 3.

## Vergleichszustaende

| Zustand | Count |
|---|---:|
| quality_reproduced | 3 |

## Staerkste gemeinsame Spuren

| Intake-Key | Basis | Gegenwelt | Zustand | Probe Count | Balance Delta | Feldinput Delta |
|---|---|---|---|---:|---:|---:|
| hoeren_hin|inner_effect_stable|dio_mcm_episode_0e7qvj1 | young_intake_trace | young_intake_trace | quality_reproduced | 994 | 0.0026 | -0.0008 |
| sehen_abstand|inner_effect_stable|dio_mcm_episode_0e7qvj1 | young_intake_trace | young_intake_trace | quality_reproduced | 772 | -0.0064 | 0.0058 |
| fuehlen_abstand|inner_effect_carried_unrest|dio_mcm_episode_0e7qvj1 | contact_loaded_intake | contact_loaded_intake | quality_reproduced | 70 | 0.0076 | -0.0149 |

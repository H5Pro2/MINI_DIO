...
|---|---|---:|---:|---:|---:|---|
| wahrnehmung | Sinnesaufnahme-Memory | 409 | 7976 | 0.4277 | 0.1909 | Weltkontakt wird kanalgetrennt als Aufnahmequalitaet lesbar. |
| benennung | dio_*-Syntax / MCM-Preview-Symbole | 139 | 8993 | 0.0000 | 0.0000 | Wiederkehrende Feldlagen werden nicht nur als Wert, sondern als eigene Syntax getragen. |
| feldwirkung | Rekopplung, Carry, Strain, Feldinput | 409 | 7976 | 0.4433 | 0.1811 | Aufnahme erzeugt eine innere Feldlage mit Tragung, Druck, Rekopplung und Strain. |
| passive_regulation | Regulationsvorschlag-Feldtragung | 54 | 61910 | 0.5586 | 0.2186 | Regulation erscheint als Wahrnehmungsfaehigkeit vor dem Feld, nicht als Gate. |
| integration | MCM-Feldbewegungs-Memory | 2 | 1017 | 0.5929 | 0.6871 | Gerichtete Feldbewegungen werden als Innenfeldspur integriert. |
| stabilisierung | konsistente Top-Qualitaet / Wiederkehr | 2 | 1017 | 0.5929 | 0.6871 | Stabilisierung zeigt sich als gereifte, wiederkehrende Bedeutungsspanne, nicht als starre Regel. |
...
| Vorschlag | Count |
|---|---:|
| contact_relief_pull | 9 |
| distance_pull | 9 |
| focus_pull | 9 |
| sharpening_pull | 9 |
| softening_pull | 9 |
| stable_listening_pull | 9 |

## Feldbewegungsqualitaeten

| Qualitaet | Count |
|---|---:|
| recurrently_fragmented | 1 |
| recurrently_carried | 1 |

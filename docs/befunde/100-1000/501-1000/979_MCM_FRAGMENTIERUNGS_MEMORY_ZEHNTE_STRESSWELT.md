...
- `fragmentierung_randlastig`: 1

## Records

| Symbol | Welt | Klasse | Zonen | junge Spuren | dominant | sekundaer | Rand | schwaches Zentrum | Rekopplung |
|---|---|---|---:|---:|---|---|---:|---:|---:|
| `dio_frag_1mbyh0o` | `ZEHNTE_STRESS_10K_REPRO` | `fragmentierung_randlastig` | 146 | 68 | `nichtbruecke_randspannung` | `nichtbruecke_zentrum_schwach` | 54 | 44 | 4 |

...
- `fragmentierung_offen_randnah_jung`: 1

## Records

| Symbol | Welt | Klasse | Zonen | junge Spuren | dominant | sekundaer | Rand | schwaches Zentrum | Rekopplung |
|---|---|---|---:|---:|---|---|---:|---:|---:|
| `dio_frag_04wbygy` | `ACHTE_SOL_15M_30M` | `fragmentierung_offen_randnah_jung` | 5995 | 5085 | `nichtbruecke_offen` | `nichtbruecke_randspannung` | 1672 | 1445 | 5 |

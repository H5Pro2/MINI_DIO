...
|---|---|---:|---:|---:|---:|---:|---|---:|---|---:|---:|---:|---:|
| RAND_DOMINANZ | lokale_rand_oeffnung | 6994 | 0.8533 | 0.1055 | 0.0043 | 0.7612 | laute_randphase | 0.0288 | laute_randphase | 0.1644 | 0.0291 | 0.8229 | 0.4625 |
| BRUCH_RAND | lokale_oeffnung_ohne_rand | 5994 | 0.8892 | 0.0719 | 0.0012 | 0.5157 | randflackern | 0.0020 | zweiter_kippimpuls | 0.0938 | 0.0130 | 0.8618 | 0.3758 |
| HARMONIC | stabile_zentrierung | 5394 | 0.9842 | 0.0076 | 0.0006 | 0.0178 | kippnaehe | 0.0011 | ruhig | 0.0278 | 0.0026 | 0.9081 | 0.1728 |

## Befund

- Staerkste lokale Oeffnung: `RAND_DOMINANZ` / `laute_randphase` mit `0.7612`.
- Staerkste lokale Rand/Kipp-Naehe: `RAND_DOMINANZ` / `laute_randphase` mit `0.0288`.
- Staerkste rezeptorische Reduktion: `RAND_DOMINANZ` / `laute_randphase` mit `0.0291`.
- Staerkste durchschnittliche Zentrierung: `HARMONIC` mit `0.9842`.

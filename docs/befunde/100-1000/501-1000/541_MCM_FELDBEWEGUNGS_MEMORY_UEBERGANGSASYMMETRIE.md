...
- `docs\befunde\540_10K_UEBERGANGSASYMMETRIE_REPRODUKTION.csv`
...
|---|---:|---:|---|---|---|---|---:|---:|---:|---:|---|
| dio_mcm_episode_183drjy->dio_mcm_episode_1t5bcxp | 1 | 168 | oeffnend_lauter_strainnaeher | oeffnend_belastend | recurrently_opening_strain | cross_world_condensed_trace | 0.0185 | -0.0219 | 0.0337 | 0.0951 | after_repro_identisch |
| dio_mcm_episode_1t5bcxp->dio_mcm_episode_183drjy | 1 | 230 | rekoppelnd_beruhigend_schaerfend | rekoppelnd_entlastend | recurrently_reconnecting | cross_world_condensed_trace | -0.0165 | 0.0231 | -0.0264 | -0.0467 | after_repro_identisch |
...
- CSV: `docs\befunde\541_MCM_FELDBEWEGUNGS_MEMORY_UEBERGANGSASYMMETRIE.csv`
- JSON: `docs\befunde\541_MCM_FELDBEWEGUNGS_MEMORY_UEBERGANGSASYMMETRIE.json`

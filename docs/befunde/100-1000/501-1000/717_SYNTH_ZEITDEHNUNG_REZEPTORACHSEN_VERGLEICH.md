# Synthetische Zeitdehnung Rezeptorachsen-Vergleich
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ZEIT_KOMPAKT | 2994 | 0.8367 | 0.1112 | 0.0020 | 0.0663 | 0.7981 | 0.0435 | 0.0387 | 0.0048 | 0.8886 | 0.5933 | 0.0200 | 0.2460 | 0.1431 | 0.0206 |
| ZEIT_GEDEHNT | 11994 | 0.9180 | 0.0459 | 0.0007 | 0.0455 | 0.8068 | 0.0329 | 0.0294 | 0.0035 | 0.8931 | 0.3208 | 0.0067 | 0.1891 | 0.1146 | 0.0158 |

## Befund

- Staerkste offene Variante im Hochlastfenster: `ZEIT_KOMPAKT` mit `0.5933`.
- Staerkste Rand/Kipp-Naehe im Hochlastfenster: `ZEIT_KOMPAKT` mit `0.0200`.
- Staerkste auditive Hochlast: `ZEIT_KOMPAKT` mit `0.2460`.
- Staerkste Adaptionsreduktion im Hochlastfenster: `ZEIT_KOMPAKT` mit `0.0206`.

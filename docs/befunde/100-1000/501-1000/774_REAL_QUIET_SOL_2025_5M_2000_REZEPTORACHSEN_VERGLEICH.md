# REAL Quiet SOL 2025 5m 2000 Rezeptorachsen
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| REAL_QUIET_SOL2025 | 1994 | 0.3661 | 0.4338 | 0.0231 | 0.2143 | 0.6527 | 0.1278 | 0.1087 | 0.0190 | 0.8512 | 0.7750 | 0.2200 | 0.5224 | 0.2980 | 0.0567 |

## Befund

- Staerkste offene Variante im Hochlastfenster: `REAL_QUIET_SOL2025` mit `0.7750`.
- Staerkste Rand/Kipp-Naehe im Hochlastfenster: `REAL_QUIET_SOL2025` mit `0.2200`.
- Staerkste auditive Hochlast: `REAL_QUIET_SOL2025` mit `0.5224`.
- Staerkste Adaptionsreduktion im Hochlastfenster: `REAL_QUIET_SOL2025` mit `0.0567`.

# REAL Sequence Break SOL 2025 5m 2000 Rezeptorachsen
...
- Staerkste Rand/Kipp-Naehe im Hochlastfenster: `REAL_SEQ_BREAK_SOL2025` mit `0.1950`.
- Staerkste auditive Hochlast: `REAL_SEQ_BREAK_SOL2025` mit `0.5087`.
- Staerkste Adaptionsreduktion im Hochlastfenster: `REAL_SEQ_BREAK_SOL2025` mit `0.0546`.

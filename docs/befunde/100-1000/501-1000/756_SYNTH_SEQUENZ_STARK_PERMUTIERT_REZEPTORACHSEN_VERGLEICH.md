# Synthetische stark permutierte Sequenz Rezeptorachsen-Vergleich
...
| STARK_PERMUTIERT | 6094 | 0.8869 | 0.0727 | 0.0015 | 0.0528 | 0.8040 | 0.0368 | 0.0328 | 0.0040 | 0.8912 | 0.4672 | 0.0148 | 0.2108 | 0.1259 | 0.0178 |

## Befund

- Staerkste offene Variante im Hochlastfenster: `STARK_PERMUTIERT` mit `0.4672`.
- Staerkste Rand/Kipp-Naehe im Hochlastfenster: `STARK_PERMUTIERT` mit `0.0148`.
- Staerkste auditive Hochlast: `STARK_PERMUTIERT` mit `0.2108`.
- Staerkste Adaptionsreduktion im Hochlastfenster: `STARK_PERMUTIERT` mit `0.0178`.

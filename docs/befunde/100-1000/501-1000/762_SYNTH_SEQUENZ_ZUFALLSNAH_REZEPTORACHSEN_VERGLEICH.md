# SYNTH Sequenz zufallsnah Rezeptorachsen Vergleich
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| SYNTH_ZUFALLSNAH | 5794 | 0.8842 | 0.0727 | 0.0016 | 0.0542 | 0.8031 | 0.0374 | 0.0333 | 0.0041 | 0.8909 | 0.4552 | 0.0155 | 0.2138 | 0.1272 | 0.0180 |

## Befund

- Staerkste offene Variante im Hochlastfenster: `SYNTH_ZUFALLSNAH` mit `0.4552`.
- Staerkste Rand/Kipp-Naehe im Hochlastfenster: `SYNTH_ZUFALLSNAH` mit `0.0155`.
- Staerkste auditive Hochlast: `SYNTH_ZUFALLSNAH` mit `0.2138`.
- Staerkste Adaptionsreduktion im Hochlastfenster: `SYNTH_ZUFALLSNAH` mit `0.0180`.

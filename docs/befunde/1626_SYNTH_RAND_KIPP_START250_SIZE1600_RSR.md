...
- Real A Welt: `data\scan_synth-rand-kipp-start0_start250_size1600.csv`
- Real B Welt: `data\scan_synth-rand-kipp-start0_start250_size1600.csv`
- gleiche Welt: `True`
- Real A Memory: `memory\real_sleep_real\synth_rand_kipp_start250_size1600_role5_repro\memory_A_real_run.json`
- Sleep Diagnose: `debug\real_sleep_real\synth_rand_kipp_start250_size1600_role5_repro\sleep`
- Memory nach Sleep: `memory\real_sleep_real\synth_rand_kipp_start250_size1600_role5_repro\memory_A_after_sleep.json`
- Real B Memory: `memory\real_sleep_real\synth_rand_kipp_start250_size1600_role5_repro\memory_B_real_run_after_sleep.json`

## Real A -> Real B

- Episoden: `1594.0` -> `1594.0`
- Unique Syntax: `100.0` -> `100.0`
- geschriebene Feldepisoden: `5.0` -> `5.0`
- MCM-Tragqualitaet: `0.579915` -> `0.580037`
- MCM-Rekopplung: `0.734699` -> `0.734579`
- MCM-Sinneskopplung: `0.886723` -> `0.886608`

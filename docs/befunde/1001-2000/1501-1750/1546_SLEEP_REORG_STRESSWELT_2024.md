...
- gleiche Welt: `False`
- Real A Memory: `memory\real_sleep_real\sol2024_sleep_reorg_to_stress2024\memory_A_real_run.json`
- Sleep Diagnose: `debug\real_sleep_real\sol2024_sleep_reorg_to_stress2024\sleep`
- Memory nach Sleep: `memory\real_sleep_real\sol2024_sleep_reorg_to_stress2024\memory_A_after_sleep.json`
- Real B Memory: `memory\real_sleep_real\sol2024_sleep_reorg_to_stress2024\memory_B_real_run_after_sleep.json`

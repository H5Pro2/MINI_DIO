...
Als nächstes sollte `dio_1fll` gegen Mischwelten geprüft werden:

```text
Rand/Bruch + Zentrum
Rand/Bruch + Realweltfenster
Rand/Bruch + ruhige Rekopplungsphasen
```

Die konkrete Frage:

```text
Bleibt dio_1fll als Rand-/Bruchrolle getrennt,
oder entsteht eine neue Brückenrolle zwischen Rand/Bruch und Zentrum?
```

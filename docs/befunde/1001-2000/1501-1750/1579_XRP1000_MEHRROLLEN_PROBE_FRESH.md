...
- Real A Welt: `data\kontrolliert_xrp2024_sleep_origin_1000_5m.csv`
- Real B Welt: `data\kontrolliert_xrp2024_sleep_same_1000_5m.csv`
- gleiche Welt: `False`
- Real A Memory: `memory\real_sleep_real\xrp1000_multirole_probe_fresh\memory_A_real_run.json`
- Sleep Diagnose: `debug\real_sleep_real\xrp1000_multirole_probe_fresh\sleep`
- Memory nach Sleep: `memory\real_sleep_real\xrp1000_multirole_probe_fresh\memory_A_after_sleep.json`
- Real B Memory: `memory\real_sleep_real\xrp1000_multirole_probe_fresh\memory_B_real_run_after_sleep.json`

## Real A -> Real B

- Episoden: `994.0` -> `994.0`
- Unique Syntax: `252.0` -> `252.0`
- geschriebene Feldepisoden: `1.0` -> `1.0`
- MCM-Tragqualitaet: `0.500207` -> `0.501041`
- MCM-Rekopplung: `0.691957` -> `0.691106`
- MCM-Sinneskopplung: `0.846187` -> `0.84539`

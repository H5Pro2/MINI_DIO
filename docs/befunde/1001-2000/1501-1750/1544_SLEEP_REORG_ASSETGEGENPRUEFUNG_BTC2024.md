...
- Real B Welt: `data\kontrolliert_btc_2024_5m_test1_2000_BTCUSDT.csv`
- gleiche Welt: `False`
- Real A Memory: `memory\real_sleep_real\sol2024_sleep_reorg_to_btc2024\memory_A_real_run.json`
- Sleep Diagnose: `debug\real_sleep_real\sol2024_sleep_reorg_to_btc2024\sleep`
- Memory nach Sleep: `memory\real_sleep_real\sol2024_sleep_reorg_to_btc2024\memory_A_after_sleep.json`
- Real B Memory: `memory\real_sleep_real\sol2024_sleep_reorg_to_btc2024\memory_B_real_run_after_sleep.json`

## Real A -> Real B

- Episoden: `1994.0` -> `1994.0`
- Unique Syntax: `351.0` -> `340.0`
- geschriebene Feldepisoden: `5.0` -> `3.0`
- MCM-Tragqualitaet: `0.509901` -> `0.513118`
- MCM-Rekopplung: `0.693318` -> `0.695028`
- MCM-Sinneskopplung: `0.83793` -> `0.841227`

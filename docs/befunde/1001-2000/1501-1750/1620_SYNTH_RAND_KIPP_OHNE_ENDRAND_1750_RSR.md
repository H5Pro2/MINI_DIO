...
- Real A Welt: `data\scan_ohne-endrand_start0_size1750.csv`
- Real B Welt: `data\scan_ohne-endrand_start0_size1750.csv`
- gleiche Welt: `True`
- Real A Memory: `memory\real_sleep_real\synth_rand_kipp_ohne_endrand_1750_role5_repro\memory_A_real_run.json`
- Sleep Diagnose: `debug\real_sleep_real\synth_rand_kipp_ohne_endrand_1750_role5_repro\sleep`
- Memory nach Sleep: `memory\real_sleep_real\synth_rand_kipp_ohne_endrand_1750_role5_repro\memory_A_after_sleep.json`
- Real B Memory: `memory\real_sleep_real\synth_rand_kipp_ohne_endrand_1750_role5_repro\memory_B_real_run_after_sleep.json`

## Real A -> Real B

- Episoden: `1744.0` -> `1744.0`
- Unique Syntax: `118.0` -> `118.0`
- geschriebene Feldepisoden: `5.0` -> `5.0`
- MCM-Tragqualitaet: `0.586326` -> `0.586308`
- MCM-Rekopplung: `0.739098` -> `0.739135`
- MCM-Sinneskopplung: `0.894224` -> `0.89425`

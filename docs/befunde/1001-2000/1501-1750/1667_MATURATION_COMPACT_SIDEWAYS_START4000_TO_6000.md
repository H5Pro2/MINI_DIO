...
- Real A Welt: `data\segment_sideways_2026_10k_start4000_size2000.csv`
- Real B Welt: `data\segment_sideways_2026_10k_start6000_size2000.csv`
- gleiche Welt: `False`
- Real A Memory: `memory\real_sleep_real\maturation_compact_sideways_start4000_to_6000\memory_A_real_run.json`
- Sleep Diagnose: `debug\real_sleep_real\maturation_compact_sideways_start4000_to_6000\sleep`
- Memory nach Sleep: `memory\real_sleep_real\maturation_compact_sideways_start4000_to_6000\memory_A_after_sleep.json`
- Real B Memory: `memory\real_sleep_real\maturation_compact_sideways_start4000_to_6000\memory_B_real_run_after_sleep.json`

## Real A -> Real B

- Episoden: `1994.0` -> `1994.0`
- Unique Syntax: `348.0` -> `335.0`
- geschriebene Feldepisoden: `560.0` -> `652.0`
- MCM-Tragqualitaet: `0.511252` -> `0.511713`
- MCM-Rekopplung: `0.695582` -> `0.693354`
- MCM-Sinneskopplung: `0.842896` -> `0.837436`
...
- `dio_mcm_episode_1t06mit`: `sleep_role_reactivated_in_follow_world` (`54` -> `115`)
- `dio_mcm_episode_02ktejt`: `sleep_role_reactivated_in_follow_world` (`30` -> `67`)

Sleep-Kombinationen im Real-B-Follow-up:

- `dio_mcm_episode_02ktejt|dio_mcm_episode_1t06mit`: `sleep_combination_fully_reactivated` (delta `[37, 61]`)

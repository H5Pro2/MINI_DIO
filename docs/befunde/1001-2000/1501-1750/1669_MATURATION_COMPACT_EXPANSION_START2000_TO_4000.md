...
- Real A Welt: `data\segment_positive_expansion_2023_10k_start2000_size2000.csv`
- Real B Welt: `data\segment_positive_expansion_2023_10k_start4000_size2000.csv`
- gleiche Welt: `False`
- Real A Memory: `memory\real_sleep_real\maturation_compact_expansion_start2000_to_4000\memory_A_real_run.json`
- Sleep Diagnose: `debug\real_sleep_real\maturation_compact_expansion_start2000_to_4000\sleep`
- Memory nach Sleep: `memory\real_sleep_real\maturation_compact_expansion_start2000_to_4000\memory_A_after_sleep.json`
- Real B Memory: `memory\real_sleep_real\maturation_compact_expansion_start2000_to_4000\memory_B_real_run_after_sleep.json`

## Real A -> Real B

- Episoden: `1994.0` -> `1994.0`
- Unique Syntax: `437.0` -> `394.0`
- geschriebene Feldepisoden: `765.0` -> `760.0`
- MCM-Tragqualitaet: `0.500369` -> `0.503435`
- MCM-Rekopplung: `0.688532` -> `0.688665`
- MCM-Sinneskopplung: `0.832899` -> `0.832746`
- Top-Syntax-Ueberlappung: `0.6`
- Top-Familien-Ueberlappung: `0.6`
...
- `dio_mcm_episode_1t06mit`: `sleep_role_reactivated_in_follow_world` (`69` -> `136`)
- `dio_mcm_episode_02ktejt`: `sleep_role_reactivated_in_follow_world` (`31` -> `63`)
- `dio_mcm_episode_016p330`: `sleep_role_reactivated_in_follow_world` (`29` -> `57`)

Sleep-Kombinationen im Real-B-Follow-up:

- `dio_mcm_episode_02ktejt|dio_mcm_episode_1t06mit`: `sleep_combination_fully_reactivated` (delta `[32, 67]`)
- `dio_mcm_episode_016p330|dio_mcm_episode_02ktejt`: `sleep_combination_fully_reactivated` (delta `[28, 32]`)
- `dio_mcm_episode_016p330|dio_mcm_episode_1t06mit`: `sleep_combination_fully_reactivated` (delta `[28, 67]`)

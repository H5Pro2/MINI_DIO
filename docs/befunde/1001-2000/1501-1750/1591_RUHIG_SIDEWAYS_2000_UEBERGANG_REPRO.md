...
- Real A Welt: `data\scan_ruhig-sideways-2026_start6000_size2000.csv`
- Real B Welt: `data\scan_ruhig-sideways-2026_start6000_size2000.csv`
- gleiche Welt: `True`
- Real A Memory: `memory\real_sleep_real\ruhig_sideways_2000_start6000_transition_repro\memory_A_real_run.json`
- Sleep Diagnose: `debug\real_sleep_real\ruhig_sideways_2000_start6000_transition_repro\sleep`
- Memory nach Sleep: `memory\real_sleep_real\ruhig_sideways_2000_start6000_transition_repro\memory_A_after_sleep.json`
- Real B Memory: `memory\real_sleep_real\ruhig_sideways_2000_start6000_transition_repro\memory_B_real_run_after_sleep.json`

## Real A -> Real B

- Episoden: `1994.0` -> `1994.0`
- Unique Syntax: `330.0` -> `330.0`
- geschriebene Feldepisoden: `3.0` -> `3.0`
- MCM-Tragqualitaet: `0.512023` -> `0.512779`
- MCM-Rekopplung: `0.694806` -> `0.69404`
- MCM-Sinneskopplung: `0.839783` -> `0.839063`

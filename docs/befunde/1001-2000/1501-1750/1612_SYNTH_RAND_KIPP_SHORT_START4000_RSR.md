...
- Real A Welt: `data\scan_rand-kipp-short_start4000_size2000.csv`
- Real B Welt: `data\scan_rand-kipp-short_start4000_size2000.csv`
- gleiche Welt: `True`
- Real A Memory: `memory\real_sleep_real\synth_rand_kipp_short_start4000_transition_repro\memory_A_real_run.json`
- Sleep Diagnose: `debug\real_sleep_real\synth_rand_kipp_short_start4000_transition_repro\sleep`
- Memory nach Sleep: `memory\real_sleep_real\synth_rand_kipp_short_start4000_transition_repro\memory_A_after_sleep.json`
- Real B Memory: `memory\real_sleep_real\synth_rand_kipp_short_start4000_transition_repro\memory_B_real_run_after_sleep.json`

## Real A -> Real B

- Episoden: `1994.0` -> `1994.0`
- Unique Syntax: `80.0` -> `80.0`
- geschriebene Feldepisoden: `3.0` -> `3.0`
- MCM-Tragqualitaet: `0.596258` -> `0.596476`
- MCM-Rekopplung: `0.745596` -> `0.745381`
- MCM-Sinneskopplung: `0.905155` -> `0.904949`
...
- `dio_mcm_episode_0wjn8vm|dio_mcm_episode_15kj0zg`: `sleep_combination_fully_reactivated` (delta `[1, 1]`)

...
- Real A Welt: `data\scan_xrp-2024-5m_start2000_size2000.csv`
- Real B Welt: `data\scan_xrp-2024-5m_start2000_size2000.csv`
- gleiche Welt: `True`
- Real A Memory: `memory\real_sleep_real\xrp2024_2000_start2000_role4_repro\memory_A_real_run.json`
- Sleep Diagnose: `debug\real_sleep_real\xrp2024_2000_start2000_role4_repro\sleep`
- Memory nach Sleep: `memory\real_sleep_real\xrp2024_2000_start2000_role4_repro\memory_A_after_sleep.json`
- Real B Memory: `memory\real_sleep_real\xrp2024_2000_start2000_role4_repro\memory_B_real_run_after_sleep.json`

## Real A -> Real B

- Episoden: `1994.0` -> `1994.0`
- Unique Syntax: `354.0` -> `354.0`
- geschriebene Feldepisoden: `5.0` -> `5.0`
- MCM-Tragqualitaet: `0.511005` -> `0.511804`
- MCM-Rekopplung: `0.69538` -> `0.694573`
- MCM-Sinneskopplung: `0.84282` -> `0.842061`
...
- `dio_mcm_episode_0sjrih9`: `sleep_role_reactivated_in_follow_world` (`2` -> `4`)

Sleep-Kombinationen im Real-B-Follow-up:

- `dio_mcm_episode_0e7qvj1|dio_mcm_episode_0sjrih9`: `sleep_combination_fully_reactivated` (delta `[1, 2]`)
...
- `dio_mcm_episode_0sjrih9|dio_mcm_episode_1k2bqha`: `sleep_combination_fully_reactivated` (delta `[2, 1]`)
- `dio_mcm_episode_0sjrih9|dio_mcm_episode_1wra2fc`: `sleep_combination_fully_reactivated` (delta `[2, 1]`)

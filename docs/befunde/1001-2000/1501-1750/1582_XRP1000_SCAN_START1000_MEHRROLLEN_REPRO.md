...
- Real A Welt: `data\scan_xrp-2024-5m-10k_start1000_size1000.csv`
- Real B Welt: `data\scan_xrp-2024-5m-10k_start1000_size1000.csv`
- gleiche Welt: `True`
- Real A Memory: `memory\real_sleep_real\xrp1000_scan_start1000_multirole_repro\memory_A_real_run.json`
- Sleep Diagnose: `debug\real_sleep_real\xrp1000_scan_start1000_multirole_repro\sleep`
- Memory nach Sleep: `memory\real_sleep_real\xrp1000_scan_start1000_multirole_repro\memory_A_after_sleep.json`
- Real B Memory: `memory\real_sleep_real\xrp1000_scan_start1000_multirole_repro\memory_B_real_run_after_sleep.json`

## Real A -> Real B

- Episoden: `994.0` -> `994.0`
- Unique Syntax: `250.0` -> `250.0`
- geschriebene Feldepisoden: `5.0` -> `5.0`
- MCM-Tragqualitaet: `0.495819` -> `0.4967`
- MCM-Rekopplung: `0.687627` -> `0.686728`
- MCM-Sinneskopplung: `0.836849` -> `0.836007`
...
- `dio_mcm_episode_0sjrih9|dio_mcm_episode_1wra2fc`: `sleep_combination_fully_reactivated` (delta `[1, 1]`)
- `dio_mcm_episode_0s9rwsa|dio_mcm_episode_0sjrih9`: `sleep_combination_fully_reactivated` (delta `[1, 1]`)

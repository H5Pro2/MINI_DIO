...
- Real A Welt: `data\scan_doge-2024-5m_start0_size2000.csv`
- Real B Welt: `data\scan_doge-2024-5m_start0_size2000.csv`
- gleiche Welt: `True`
- Real A Memory: `memory\real_sleep_real\doge2024_2000_start0_role5_repro\memory_A_real_run.json`
- Sleep Diagnose: `debug\real_sleep_real\doge2024_2000_start0_role5_repro\sleep`
- Memory nach Sleep: `memory\real_sleep_real\doge2024_2000_start0_role5_repro\memory_A_after_sleep.json`
- Real B Memory: `memory\real_sleep_real\doge2024_2000_start0_role5_repro\memory_B_real_run_after_sleep.json`

## Real A -> Real B

- Episoden: `1994.0` -> `1994.0`
- Unique Syntax: `355.0` -> `355.0`
- geschriebene Feldepisoden: `5.0` -> `5.0`
- MCM-Tragqualitaet: `0.511081` -> `0.511842`
- MCM-Rekopplung: `0.694397` -> `0.693629`
- MCM-Sinneskopplung: `0.839304` -> `0.83858`
...
- `dio_mcm_episode_0s9rwsa`: `sleep_role_reactivated_in_follow_world` (`1` -> `2`)
...
- `dio_mcm_episode_0e7qvj1|dio_mcm_episode_0s9rwsa`: `sleep_combination_fully_reactivated` (delta `[1, 1]`)
- `dio_mcm_episode_0s9rwsa|dio_mcm_episode_1k2bqha`: `sleep_combination_fully_reactivated` (delta `[1, 1]`)
- `dio_mcm_episode_0s9rwsa|dio_mcm_episode_1wra2fc`: `sleep_combination_fully_reactivated` (delta `[1, 1]`)
- `dio_mcm_episode_0e7qvj1|dio_mcm_episode_0ryrezu`: `sleep_combination_fully_reactivated` (delta `[1, 1]`)
...
- `dio_mcm_episode_0ryrezu|dio_mcm_episode_0s9rwsa`: `sleep_combination_fully_reactivated` (delta `[1, 1]`)

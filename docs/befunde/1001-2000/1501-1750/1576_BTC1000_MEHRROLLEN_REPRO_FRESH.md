...
- Real A Welt: `data\kontrolliert_btc2024_sleep_origin_1000_5m.csv`
- Real B Welt: `data\kontrolliert_btc2024_sleep_same_1000_5m.csv`
- gleiche Welt: `False`
- Real A Memory: `memory\real_sleep_real\btc1000_multirole_repro_fresh\memory_A_real_run.json`
- Sleep Diagnose: `debug\real_sleep_real\btc1000_multirole_repro_fresh\sleep`
- Memory nach Sleep: `memory\real_sleep_real\btc1000_multirole_repro_fresh\memory_A_after_sleep.json`
- Real B Memory: `memory\real_sleep_real\btc1000_multirole_repro_fresh\memory_B_real_run_after_sleep.json`

## Real A -> Real B

- Episoden: `994.0` -> `994.0`
- Unique Syntax: `243.0` -> `243.0`
- geschriebene Feldepisoden: `3.0` -> `3.0`
- MCM-Tragqualitaet: `0.49869` -> `0.499548`
- MCM-Rekopplung: `0.689853` -> `0.688984`
- MCM-Sinneskopplung: `0.841297` -> `0.84048`

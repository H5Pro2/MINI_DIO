...
- Real A Welt: `data\scan_synth-rand-kipp_start0_size2000.csv`
- Real B Welt: `data\scan_synth-rand-kipp_start0_size2000.csv`
- gleiche Welt: `True`
- Real A Memory: `memory\real_sleep_real\synth_rand_kipp_2000_start0_multirole_repro\memory_A_real_run.json`
- Sleep Diagnose: `debug\real_sleep_real\synth_rand_kipp_2000_start0_multirole_repro\sleep`
- Memory nach Sleep: `memory\real_sleep_real\synth_rand_kipp_2000_start0_multirole_repro\memory_A_after_sleep.json`
- Real B Memory: `memory\real_sleep_real\synth_rand_kipp_2000_start0_multirole_repro\memory_B_real_run_after_sleep.json`

## Real A -> Real B

- Episoden: `1994.0` -> `1994.0`
- Unique Syntax: `109.0` -> `109.0`
- geschriebene Feldepisoden: `5.0` -> `5.0`
- MCM-Tragqualitaet: `0.580908` -> `0.580991`
- MCM-Rekopplung: `0.734612` -> `0.734537`
- MCM-Sinneskopplung: `0.885301` -> `0.885226`

# 1926 - BTC B Fokus 3200 5200 Repro
...
- Folgefenster: `docs\befunde\1924_BTC_B_FOCUS_3200_5200.csv`.
...
- Repro-Zustände: `fehlt_im_folgefenster:644; lokale_qualitaet_wird_nachhallnah:2; lokale_qualitaet_reproduziert:2; qualitaet_reproduziert:2; lokale_qualitaet_wird_offen:1`
- Baseline-Zustände: `phasenlokal_eigenstaendig:446; geteilt_offen:101; einzelbeleg:57; fenstergetragen_stabil:47`
- Eigenständige Baseline-Familien: `fehlt_im_folgefenster:441; lokale_qualitaet_wird_nachhallnah:2; lokale_qualitaet_reproduziert:2; lokale_qualitaet_wird_offen:1`
- Asset-Profil: `PAXG::fehlt_im_folgefenster:135; SOL::fehlt_im_folgefenster:135; XRP::fehlt_im_folgefenster:135; DOGE::fehlt_im_folgefenster:120; BTC::fehlt_im_folgefenster:119; BTC::lokale_qualitaet_wird_nachhallnah:2; BTC::lokale_qualitaet_reproduziert:2; BTC::qualitaet_reproduziert:2; BTC::lokale_qualitaet_wird_offen:1`
...
| `lokale_qualitaet_wird_nachhallnah` | 2 | 0.003 |
| `lokale_qualitaet_reproduziert` | 2 | 0.003 |
...
| BTC | `dio_1kpz` | `spaet` | `phase_nullnah` | `phase_nullnah` | `lokale_qualitaet_reproduziert` | `phase_nullnah:3; phase_offen_gemischt:2; phase_nachhallnah_ohne_kern:1` | `phase_nullnah:1` |

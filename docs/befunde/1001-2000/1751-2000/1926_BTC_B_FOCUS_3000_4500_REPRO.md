# 1926 - BTC B Fokus 3000 4500 Repro
...
- Folgefenster: `docs\befunde\1924_BTC_B_FOCUS_3000_4500.csv`.
...
- Repro-Zustände: `fehlt_im_folgefenster:639; lokale_qualitaet_reproduziert:6; lokale_qualitaet_driftet:2; qualitaet_reproduziert:2; lokale_qualitaet_wird_offen:1; lokale_qualitaet_wird_nullnah:1`
- Baseline-Zustände: `phasenlokal_eigenstaendig:446; geteilt_offen:101; einzelbeleg:57; fenstergetragen_stabil:47`
- Eigenständige Baseline-Familien: `fehlt_im_folgefenster:436; lokale_qualitaet_reproduziert:6; lokale_qualitaet_driftet:2; lokale_qualitaet_wird_offen:1; lokale_qualitaet_wird_nullnah:1`
- Asset-Profil: `PAXG::fehlt_im_folgefenster:135; SOL::fehlt_im_folgefenster:135; XRP::fehlt_im_folgefenster:135; DOGE::fehlt_im_folgefenster:120; BTC::fehlt_im_folgefenster:114; BTC::lokale_qualitaet_reproduziert:6; BTC::lokale_qualitaet_driftet:2; BTC::qualitaet_reproduziert:2; BTC::lokale_qualitaet_wird_offen:1; BTC::lokale_qualitaet_wird_nullnah:1`
...
| BTC | `dio_1kpz` | `mitte` | `phase_offen_gemischt` | `phase_offen_gemischt` | `lokale_qualitaet_reproduziert` | `phase_offen_gemischt:3; phase_nullnah:2; phase_nachhallnah_ohne_kern:1` | `phase_offen_gemischt:1` |
...
| BTC | `dio_06er` | `frueh` | `phase_nullnah` | `phase_ohne_nullfamilie` | `lokale_qualitaet_driftet` | `phase_nullnah:5; phase_offen_gemischt:1` | `phase_ohne_nullfamilie:1` |

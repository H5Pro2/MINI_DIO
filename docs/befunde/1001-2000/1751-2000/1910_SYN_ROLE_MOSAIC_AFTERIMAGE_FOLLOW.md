# 1910 - Synthetische Weltpassung Rollen Mosaik Nachhall Follow
...
|---|---:|---:|---:|---:|---:|---:|---|
| `real` | 1 | 10.00 | 0.105 | 0.065 | 0.2242 | 0.2285 | `reifungsrolle_reproduziert:1` |
| `null_random` | 1 | 26.00 | 0.151 | 0.021 | 0.3785 | 0.2663 | `reifungsrolle_reproduziert:1` |
| `null_shuffle` | 1 | 34.00 | 0.585 | 0.239 | 0.4125 | 0.2064 | `reifungsrolle_reproduziert:1` |

## Fensterlesung

| Asset | Start | Quellenvorsprung | Kernvorsprung | Nachhallvorsprung | Feldzeitvorsprung | Feldvorsprung | Lesung |
|---|---:|---:|---:|---:|---:|---:|---|
| DOGE | 0 | -0.4796 | -0.1746 | -0.1883 | -0.0378 | -0.2324 | `nullwelt_staerker` |

# 1886P2 - PAXG-Hartkern: Reproduktion 7000 8000
...
- Folgefenster: `docs\befunde\1885P2_PAXG_HARTKERN_FOLGEFENSTER_7000_8000.csv`.
...
- Repro-Zustände: `fehlt_im_folgefenster:554; lokale_qualitaet_wird_nullnah:24; lokale_qualitaet_reproduziert:23; lokale_qualitaet_wird_offen:17; qualitaet_reproduziert:11; lokale_qualitaet_driftet:9; lokale_qualitaet_wird_nachhallnah:8; lokale_qualitaet_wird_kernnah:5`
- Baseline-Zustände: `phasenlokal_eigenstaendig:446; geteilt_offen:101; einzelbeleg:57; fenstergetragen_stabil:47`
- Eigenständige Baseline-Familien: `fehlt_im_folgefenster:397; lokale_qualitaet_reproduziert:23; lokale_qualitaet_wird_nullnah:9; lokale_qualitaet_wird_offen:7; lokale_qualitaet_wird_nachhallnah:4; lokale_qualitaet_wird_kernnah:3; lokale_qualitaet_driftet:3`
- Asset-Profil: `SOL::fehlt_im_folgefenster:135; XRP::fehlt_im_folgefenster:135; BTC::fehlt_im_folgefenster:126; DOGE::fehlt_im_folgefenster:120; PAXG::fehlt_im_folgefenster:38; PAXG::lokale_qualitaet_wird_nullnah:24; PAXG::lokale_qualitaet_reproduziert:23; PAXG::lokale_qualitaet_wird_offen:17; PAXG::qualitaet_reproduziert:11; PAXG::lokale_qualitaet_driftet:9; PAXG::lokale_qualitaet_wird_nachhallnah:8; PAXG::lokale_qualitaet_wird_kernnah:5`
...
| `lokale_qualitaet_wird_nullnah` | 24 | 0.037 |
| `lokale_qualitaet_reproduziert` | 23 | 0.035 |
| `lokale_qualitaet_wird_offen` | 17 | 0.026 |
| `qualitaet_reproduziert` | 11 | 0.017 |
| `lokale_qualitaet_driftet` | 9 | 0.014 |
| `lokale_qualitaet_wird_nachhallnah` | 8 | 0.012 |
| `lokale_qualitaet_wird_kernnah` | 5 | 0.008 |

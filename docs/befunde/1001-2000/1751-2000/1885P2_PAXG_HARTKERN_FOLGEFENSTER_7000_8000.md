# 1885P2 - PAXG Hartkern Folgefenster 7000 8000
...
|---|---:|---:|---:|---:|---:|---:|---|
| `real` | 1 | 30.00 | 0.527 | 0.293 | 0.3838 | 0.3793 | `reifungsrolle_reproduziert:1` |
| `null_random` | 1 | 24.00 | 0.615 | 0.270 | 0.3623 | 0.3141 | `reifungsrolle_reproduziert:1` |
| `null_shuffle` | 1 | 35.00 | 0.500 | 0.184 | 0.4375 | 0.3353 | `reifungsrolle_reproduziert:1` |

## Fensterlesung

| Asset | Start | Quellenvorsprung | Kernvorsprung | Nachhallvorsprung | Feldzeitvorsprung | Feldvorsprung | Lesung |
|---|---:|---:|---:|---:|---:|---:|---|
| PAXG | 0 | -0.0881 | 0.0224 | -0.0538 | 0.0441 | -0.0134 | `graduell_kernnaehe_ohne_feldzeitvorsprung` |

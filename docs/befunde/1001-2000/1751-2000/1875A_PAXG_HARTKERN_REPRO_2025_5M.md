# 1875A - PAXG-Hartkern: Reproduktion 2025 5m
...
- Folgefenster: `docs\befunde\1874A_PAXG_HARTKERN_2025_5M.csv`.
...
- Repro-Zustände: `fehlt_im_folgefenster:546; lokale_qualitaet_reproduziert:34; qualitaet_reproduziert:26; lokale_qualitaet_wird_offen:18; lokale_qualitaet_wird_kernnah:13; lokale_qualitaet_wird_nachhallnah:7; lokale_qualitaet_wird_nullnah:4; lokale_qualitaet_driftet:3`
- Baseline-Zustände: `phasenlokal_eigenstaendig:446; geteilt_offen:101; einzelbeleg:57; fenstergetragen_stabil:47`
- Eigenständige Baseline-Familien: `fehlt_im_folgefenster:385; lokale_qualitaet_reproduziert:34; lokale_qualitaet_wird_offen:10; lokale_qualitaet_wird_kernnah:8; lokale_qualitaet_wird_nachhallnah:6; lokale_qualitaet_wird_nullnah:3`
- Asset-Profil: `SOL::fehlt_im_folgefenster:135; XRP::fehlt_im_folgefenster:135; BTC::fehlt_im_folgefenster:126; DOGE::fehlt_im_folgefenster:120; PAXG::lokale_qualitaet_reproduziert:34; PAXG::fehlt_im_folgefenster:30; PAXG::qualitaet_reproduziert:26; PAXG::lokale_qualitaet_wird_offen:18; PAXG::lokale_qualitaet_wird_kernnah:13; PAXG::lokale_qualitaet_wird_nachhallnah:7; PAXG::lokale_qualitaet_wird_nullnah:4; PAXG::lokale_qualitaet_driftet:3`
...
| `qualitaet_reproduziert` | 26 | 0.040 |
...
| PAXG | `dio_06er` | `mitte` | `phase_nachhallnah_ohne_kern` | `phase_nachhallnah_ohne_kern` | `lokale_qualitaet_reproduziert` | `phase_nachhallnah_ohne_kern:5; phase_offen_gemischt:1` | `phase_nachhallnah_ohne_kern:1` |
| PAXG | `dio_09bn` | `mitte` | `phase_nullnah` | `phase_nullnah` | `lokale_qualitaet_reproduziert` | `phase_nullnah:2` | `phase_nullnah:1` |
| PAXG | `dio_0fe7` | `frueh` | `phase_offen_gemischt` | `phase_offen_gemischt` | `lokale_qualitaet_reproduziert` | `phase_offen_gemischt:2; phase_nullnah:1; phase_ohne_nullfamilie:1` | `phase_offen_gemischt:1` |
| PAXG | `dio_0jqc` | `mitte` | `phase_nachhallnah_ohne_kern` | `phase_nachhallnah_ohne_kern` | `lokale_qualitaet_reproduziert` | `phase_nachhallnah_ohne_kern:3; phase_offen_gemischt:2; phase_nullnah:1` | `phase_nachhallnah_ohne_kern:1` |

...
Quelle: `reports/core_family_bridge_character.csv`

## Rollenkarte

| Familie | Rolle | Bridge Score | Distanz | Rollen | Lesung |
|---|---|---:|---:|---:|---|
| `dio_0l7p` | `brueckentraeger` | 0.686947 | 0.206699 | 7 | spitze Rekopplung im Ereignis, danach offenere Nachprüfung |
| `dio_104t` | `anschluss_kohärenzknoten` | 0.669413 | 0.200303 | 8 | hält Rekopplung im Nachlauf länger |
| `dio_14wj` | `breiter_uebergangsknoten` | 0.660232 | 0.236628 | 6 | breite Rollennähe mit sichtbarer Zielbrücke |
| `dio_1fll` | `randnaher_sammelknoten` | 0.465 | 0.264148 | 6 | breit, aber distanzierter und stärker randnah |
| `dio_0m9z` | `hoer_nachhall_knoten` | 0.453667 | 0.224561 | 7 | stärker über Hören und Nachhall differenziert |
| `dio_155c` | `hoer_nachhall_knoten` | 0.326914 | 0.247113 | 8 | stärker über Hören und Nachhall differenziert |

# 1916 - Synthetische Reproduktion B Fokus 2400 3900
...
- Folgefenster: `docs\befunde\1915_SYN_B_FOCUS_2400_3900.csv`.
...
- Repro-Zustände: `fehlt_im_folgefenster:637; lokale_qualitaet_wird_offen:8; lokale_qualitaet_wird_kernnah:3; lokale_qualitaet_driftet:1; lokale_qualitaet_wird_nullnah:1; qualitaet_reproduziert:1`
- Baseline-Zustände: `phasenlokal_eigenstaendig:446; geteilt_offen:101; einzelbeleg:57; fenstergetragen_stabil:47`
- Eigenständige Baseline-Familien: `fehlt_im_folgefenster:437; lokale_qualitaet_wird_offen:5; lokale_qualitaet_wird_kernnah:2; lokale_qualitaet_driftet:1; lokale_qualitaet_wird_nullnah:1`
- Asset-Profil: `PAXG::fehlt_im_folgefenster:135; SOL::fehlt_im_folgefenster:135; XRP::fehlt_im_folgefenster:135; BTC::fehlt_im_folgefenster:126; DOGE::fehlt_im_folgefenster:106; DOGE::lokale_qualitaet_wird_offen:8; DOGE::lokale_qualitaet_wird_kernnah:3; DOGE::lokale_qualitaet_driftet:1; DOGE::lokale_qualitaet_wird_nullnah:1; DOGE::qualitaet_reproduziert:1`
...
| `lokale_qualitaet_wird_offen` | 8 | 0.012 |
...
| BTC | `dio_0h9h` | `frueh` | `phase_nullnah` | `fehlt` | `fehlt_im_folgefenster` | `phase_nullnah:6` | `` |
| BTC | `dio_0h9h` | `mitte` | `phase_offen_gemischt` | `fehlt` | `fehlt_im_folgefenster` | `phase_offen_gemischt:3; phase_nullnah:2; phase_nachhallnah_ohne_kern:1` | `` |
| BTC | `dio_0h9h` | `spaet` | `phase_nachhallnah_ohne_kern` | `fehlt` | `fehlt_im_folgefenster` | `phase_nachhallnah_ohne_kern:4; phase_nullnah:1; phase_offen_gemischt:1` | `` |

# 1064 - Tonale Energie Topologie Rollen Weitere Weltgruppe
...
- `tonal_low` dominant: `offen_unruhig` (0.347 im Band, Rekopplung 0.729, Strain 0.142).
- `tonal_mid` dominant: `zentrum_rekoppelnd` (0.447 im Band, Rekopplung 0.747, Strain 0.120).
- `tonal_high` dominant: `rand_kipp` (0.333 im Band, Rekopplung 0.685, Strain 0.177).

## Befund zu `tonal_high`

- Rand/Kipp-Anteil im hohen Tonband: 0.333.
- Offen-unruhiger Anteil im hohen Tonband: 0.296.
- Zentrums-rekoppelnder Anteil im hohen Tonband: 0.098.

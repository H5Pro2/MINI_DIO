# 1063 - Tonale Energie und Topologie-Rollen
...
- `tonal_low` dominant: `offen_unruhig` (0.305 im Band, Rekopplung 0.702, Strain 0.159).
- `tonal_mid` dominant: `zentrum_rekoppelnd` (0.435 im Band, Rekopplung 0.728, Strain 0.121).
- `tonal_high` dominant: `rand_kipp` (0.422 im Band, Rekopplung 0.650, Strain 0.204).

## Befund zu `tonal_high`

- Rand/Kipp-Anteil im hohen Tonband: 0.422.
- Offen-unruhiger Anteil im hohen Tonband: 0.203.
- Zentrums-rekoppelnder Anteil im hohen Tonband: 0.151.

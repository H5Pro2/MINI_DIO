...
- Ausgewertete Episoden-Dateien: 56.
- Ausgewertete Welt/Band-Profile: 84.
- `tonal_high` Rekopplung-minus-Strain: 0.517105.
- `tonal_low` Rekopplung-minus-Strain: 0.540482.
- `tonal_high` Strain-Delta zur Weltbasis: 0.013722.
- `tonal_low` Strain-Delta zur Weltbasis: 0.004484.
- `tonal_high` Rekopplungs-Delta zur Weltbasis: -0.013567.
- `tonal_low` Rekopplungs-Delta zur Weltbasis: 0.000572.

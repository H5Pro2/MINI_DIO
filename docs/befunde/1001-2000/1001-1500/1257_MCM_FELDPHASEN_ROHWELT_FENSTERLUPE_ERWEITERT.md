...
- gekoppelte Rohfenster: `903`
- nicht gekoppelte Events: `{'keine_eindeutige_rohwelt': 1752}`
- Bewegungsarten: `{'bewegungsbruch': 895, 'gemischte_rohwelt': 7, 'bruch_koerperlast': 1}`
- Feldfenster-Lesarten: `{'lastkontakt_entlastet': 811, 'rekopplung_bricht_in_last': 61, 'gemischtes_fenster': 21, 'rekopplung_vor_neuer_last': 9, 'lastkontakt_bleibt': 1}`
- Welten: `{'XRP_5M_10K': 143, 'POS_EXPANSION_10K': 142, 'NEG_STRESS_10K': 125, 'DOGE_5M_10K': 124, 'SIDEWAYS_10K': 111, 'PAXG_5M_10K': 74, 'BTC_1H_2K': 43, 'SOL_1H_2K': 41, 'KAS_5M_2K': 36, 'SOL_5M_2K': 33, 'BTC_5M_2K': 31}`

## Phasenbezug

- `zentrum_stabil->spannungsrand_kippnaehe->offene_variante`: `408`
- `offene_variante->spannungsrand_kippnaehe->offene_variante`: `322`
- `rekopplungsnaehe->spannungsrand_kippnaehe->offene_variante`: `87`
- `spannungsrand_kippnaehe->zentrum_stabil->rekopplungsnaehe`: `22`
- `offene_variante->spannungsrand_kippnaehe->rekopplungsnaehe`: `19`
- `rekopplungsnaehe->spannungsrand_kippnaehe->rekopplungsnaehe`: `14`
- `offene_variante->spannungsrand_kippnaehe->zentrum_stabil`: `14`
- `rekopplungsnaehe->spannungsrand_kippnaehe->zentrum_stabil`: `9`

...
![BTC_QUIET_CURRENT offene_variante->spannungsrand_kippnaehe Tick 3189](../../../bilder/1233_BTC_QUIET_CURRENT_offene_variante_to_spannungsrand_kippnaehe_tick_3189.png)

- `BTC_STRESS_CURRENT` Tick `481`: vorherige Dauer `1`, aktuelle Dauer `1`, Rohfeld `0.5417`, Rekopplung `0.5578`, Strain `0.3187`
![BTC_STRESS_CURRENT offene_variante->spannungsrand_kippnaehe Tick 481](../../../bilder/1233_BTC_STRESS_CURRENT_offene_variante_to_spannungsrand_kippnaehe_tick_481.png)

- `BTC_STRESS_CURRENT` Tick `48`: vorherige Dauer `2`, aktuelle Dauer `1`, Rohfeld `0.5377`, Rekopplung `0.5561`, Strain `0.3230`
![BTC_STRESS_CURRENT offene_variante->spannungsrand_kippnaehe Tick 48](../../../bilder/1233_BTC_STRESS_CURRENT_offene_variante_to_spannungsrand_kippnaehe_tick_48.png)

- `BTC_STRESS_CURRENT` Tick `3510`: vorherige Dauer `2`, aktuelle Dauer `1`, Rohfeld `0.5370`, Rekopplung `0.5554`, Strain `0.3246`
![BTC_STRESS_CURRENT offene_variante->spannungsrand_kippnaehe Tick 3510](../../../bilder/1233_BTC_STRESS_CURRENT_offene_variante_to_spannungsrand_kippnaehe_tick_3510.png)
...
![SOL_STRESS_CURRENT spannungsrand_kippnaehe->offene_variante Tick 3322](../../../bilder/1233_SOL_STRESS_CURRENT_spannungsrand_kippnaehe_to_offene_variante_tick_3322.png)

- `SOL_QUIET_CURRENT` Tick `3903`: vorherige Dauer `1`, aktuelle Dauer `1`, Rohfeld `0.3168`, Rekopplung `0.6238`, Strain `0.2257`
![SOL_QUIET_CURRENT spannungsrand_kippnaehe->offene_variante Tick 3903](../../../bilder/1233_SOL_QUIET_CURRENT_spannungsrand_kippnaehe_to_offene_variante_tick_3903.png)

- `BTC_QUIET_CURRENT` Tick `1556`: vorherige Dauer `1`, aktuelle Dauer `1`, Rohfeld `0.3039`, Rekopplung `0.6299`, Strain `0.2271`
![BTC_QUIET_CURRENT spannungsrand_kippnaehe->offene_variante Tick 1556](../../../bilder/1233_BTC_QUIET_CURRENT_spannungsrand_kippnaehe_to_offene_variante_tick_1556.png)

- `SOL_QUIET_CURRENT` Tick `3371`: vorherige Dauer `1`, aktuelle Dauer `1`, Rohfeld `0.2972`, Rekopplung `0.6119`, Strain `0.2376`
![SOL_QUIET_CURRENT spannungsrand_kippnaehe->offene_variante Tick 3371](../../../bilder/1233_SOL_QUIET_CURRENT_spannungsrand_kippnaehe_to_offene_variante_tick_3371.png)

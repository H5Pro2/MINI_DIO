...
|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 1219_FELDPHASEN_MATRIX_MEHRWELTEN_SEGMENTE | offene_variante | 10906 | 19297 | 0.3096 | 0.6063 | 0.1821 | 0.6711 | 0.1768 | laut_unscharf_feldstark_offen |
| 1219_FELDPHASEN_MATRIX_MEHRWELTEN_SEGMENTE | rekopplungsnaehe | 7444 | 8738 | 0.2048 | 0.6494 | 0.1225 | 0.7051 | 0.1500 | mittelton_mittelsicht_feldmittel_getragen |
| 1219_FELDPHASEN_MATRIX_MEHRWELTEN_SEGMENTE | spannungsrand_kippnaehe | 1021 | 1128 | 0.6813 | 0.5441 | 0.3914 | 0.5880 | 0.2780 | laut_unscharf_feldstark_angespannt |
| 1219_FELDPHASEN_MATRIX_MEHRWELTEN_SEGMENTE | zentrum_stabil | 12511 | 40771 | 0.1472 | 0.6834 | 0.0904 | 0.7239 | 0.1379 | leise_scharf_feldduenn_getragen |
| 1221_FELDPHASEN_MATRIX_SYNTH_EXTREMWELTEN_SEGMENTE | offene_variante | 2382 | 5607 | 0.2274 | 0.6034 | 0.1364 | 0.6747 | 0.1686 | mittelton_unscharf_feldmittel_offen |
| 1221_FELDPHASEN_MATRIX_SYNTH_EXTREMWELTEN_SEGMENTE | rekopplungsnaehe | 2175 | 2742 | 0.1187 | 0.6714 | 0.0785 | 0.7067 | 0.1377 | leise_scharf_feldduenn_getragen |
| 1221_FELDPHASEN_MATRIX_SYNTH_EXTREMWELTEN_SEGMENTE | spannungsrand_kippnaehe | 158 | 165 | 0.7027 | 0.5489 | 0.4017 | 0.6009 | 0.2738 | laut_unscharf_feldstark_angespannt |
| 1221_FELDPHASEN_MATRIX_SYNTH_EXTREMWELTEN_SEGMENTE | zentrum_stabil | 2321 | 78908 | 0.0367 | 0.8254 | 0.0274 | 0.7543 | 0.1211 | leise_scharf_feldduenn_getragen |
| 1223_STRESS_QUIET_FELDPHASEN_VERGLEICH_2024_5M_SEGMENTE | offene_variante | 906 | 14858 | 0.0000 | 0.0000 | 0.0000 | 0.6506 | 0.1825 | leise_unscharf_feldduenn_offen |
| 1223_STRESS_QUIET_FELDPHASEN_VERGLEICH_2024_5M_SEGMENTE | rekopplungsnaehe | 94 | 102 | 0.0000 | 0.0000 | 0.0000 | 0.7072 | 0.1243 | leise_unscharf_feldduenn_getragen |
| 1223_STRESS_QUIET_FELDPHASEN_VERGLEICH_2024_5M_SEGMENTE | spannungsrand_kippnaehe | 821 | 1015 | 0.0000 | 0.0000 | 0.0000 | 0.5937 | 0.2868 | leise_unscharf_feldduenn_angespannt |
| 1223_STRESS_QUIET_FELDPHASEN_VERGLEICH_2024_5M_SEGMENTE | zentrum_stabil | 1 | 1 | 0.0000 | 0.0000 | 0.0000 | 0.7186 | 0.1209 | leise_unscharf_feldduenn_getragen |
...
- Staerkste Rekopplung: `1221_FELDPHASEN_MATRIX_SYNTH_EXTREMWELTEN_SEGMENTE` mit `0.6747`.
- Schaerfste Sicht: `SYNTH_SENSORY_AXES` mit `0.6289`.
- Lauteste Aufnahme: `SYNTH_SENSORY_AXES` mit `0.3359`.

### rekopplungsnaehe

- Staerkster Feldkontakt: `1219_FELDPHASEN_MATRIX_MEHRWELTEN_SEGMENTE` mit `0.1225`.
- Staerkste Rekopplung: `1223_STRESS_QUIET_FELDPHASEN_VERGLEICH_2024_5M_SEGMENTE` mit `0.7072`.
- Schaerfste Sicht: `1221_FELDPHASEN_MATRIX_SYNTH_EXTREMWELTEN_SEGMENTE` mit `0.6714`.
- Lauteste Aufnahme: `1219_FELDPHASEN_MATRIX_MEHRWELTEN_SEGMENTE` mit `0.2048`.

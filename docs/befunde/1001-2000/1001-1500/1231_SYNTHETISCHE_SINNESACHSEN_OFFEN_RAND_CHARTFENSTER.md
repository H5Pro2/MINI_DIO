...
![SYNTH_DESYNC_AXES offene_variante->spannungsrand_kippnaehe Tick 2043](../../../bilder/1231_SYNTH_DESYNC_AXES_offene_variante_to_spannungsrand_kippnaehe_tick_2043.png)

- `SYNTH_DESYNC_AXES` Tick `904`: vorherige Dauer `2`, aktuelle Dauer `1`, Rohfeld `0.4298`, Rekopplung `0.5862`, Strain `0.2807`
![SYNTH_DESYNC_AXES offene_variante->spannungsrand_kippnaehe Tick 904](../../../bilder/1231_SYNTH_DESYNC_AXES_offene_variante_to_spannungsrand_kippnaehe_tick_904.png)

- `SYNTH_DESYNC_AXES` Tick `938`: vorherige Dauer `2`, aktuelle Dauer `1`, Rohfeld `0.4257`, Rekopplung `0.6205`, Strain `0.2515`
![SYNTH_DESYNC_AXES offene_variante->spannungsrand_kippnaehe Tick 938](../../../bilder/1231_SYNTH_DESYNC_AXES_offene_variante_to_spannungsrand_kippnaehe_tick_938.png)

- `SYNTH_DESYNC_AXES` Tick `955`: vorherige Dauer `2`, aktuelle Dauer `1`, Rohfeld `0.4253`, Rekopplung `0.6249`, Strain `0.2515`
![SYNTH_DESYNC_AXES offene_variante->spannungsrand_kippnaehe Tick 955](../../../bilder/1231_SYNTH_DESYNC_AXES_offene_variante_to_spannungsrand_kippnaehe_tick_955.png)
...
![SYNTH_VISUAL_STABLE_HEARING_CHAOTIC spannungsrand_kippnaehe->offene_variante Tick 3401](../../../bilder/1231_SYNTH_VISUAL_STABLE_HEARING_CHAOTIC_spannungsrand_kippnaehe_to_offene_variante_tick_3401.png)

- `SYNTH_DESYNC_AXES` Tick `6301`: vorherige Dauer `1`, aktuelle Dauer `1`, Rohfeld `0.3167`, Rekopplung `0.6150`, Strain `0.2451`
![SYNTH_DESYNC_AXES spannungsrand_kippnaehe->offene_variante Tick 6301](../../../bilder/1231_SYNTH_DESYNC_AXES_spannungsrand_kippnaehe_to_offene_variante_tick_6301.png)

- `SYNTH_DESYNC_AXES` Tick `3201`: vorherige Dauer `1`, aktuelle Dauer `2`, Rohfeld `0.3011`, Rekopplung `0.6269`, Strain `0.2251`
![SYNTH_DESYNC_AXES spannungsrand_kippnaehe->offene_variante Tick 3201](../../../bilder/1231_SYNTH_DESYNC_AXES_spannungsrand_kippnaehe_to_offene_variante_tick_3201.png)

- `SYNTH_DESYNC_AXES` Tick `4401`: vorherige Dauer `1`, aktuelle Dauer `3`, Rohfeld `0.2938`, Rekopplung `0.6537`, Strain `0.1975`
![SYNTH_DESYNC_AXES spannungsrand_kippnaehe->offene_variante Tick 4401](../../../bilder/1231_SYNTH_DESYNC_AXES_spannungsrand_kippnaehe_to_offene_variante_tick_4401.png)

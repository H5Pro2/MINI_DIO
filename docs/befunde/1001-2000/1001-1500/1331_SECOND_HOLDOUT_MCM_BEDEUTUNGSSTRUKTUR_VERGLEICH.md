...
Diese Diagnose vergleicht `1317_MCM_BEDEUTUNGSSTRUKTUR_MEMORY.csv` mit `1330_SECOND_HOLDOUT_MCM_BEDEUTUNGSSTRUKTUR_MEMORY.csv`.
...
- `stabil_wiedererkannt`: `4`
- `feldform_wiedererkannt_faerbung_veraendert`: `1`
...
| PAXG | `stabil_wiedererkannt` | `ruhig_zentrumsnah->normale_weltspannung` | `ruhig_zentrumsnah->normale_weltspannung` | `hoeren_mittel|sehen_mittel|felddruck_mittel|range_niedrig` | `hoeren_mittel|sehen_mittel|felddruck_mittel|range_niedrig` |

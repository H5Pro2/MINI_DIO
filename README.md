...
- **Selektivität als Feldmilieu**
  Eine gedaempfte synthetische Randdominanz-Welt erzeugte ebenfalls 5 Rollen und 10 Kombinationen, rekoppelte aber vollständig. Damit ist die selektive Offline-Reorganisation nicht durch Rollenbreite, Nachhall oder synthetische Herkunft allein erklärbar. Aktuell wird sie als Feldmilieu-Effekt gelesen: Rand-/Kippnähe, Nachhall, Co-Touch-Qualität und gespannte Rollen wirken zusammen.

  Siehe dazu [1608 Gedaempfte 5-Rollen-Nachhall-Suche](docs/befunde/1608_SYNTH_GEDAEMPFT_5ROLLEN_NACHHALL_SUCHLAUF.md), [1609 Synth Randdominanz gedaempft Role5 Repro](docs/befunde/1609_SYNTH_RAND_DOMINANZ_GEDAEMPFT_2000_ROLE5_REPRO.md) und [1610 Selektivität ist Feldmilieu](docs/befunde/1610_SELEKTIVITAET_IST_FELDMILIEU_NICHT_ROLLENBREITE.md).

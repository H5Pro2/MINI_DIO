...
Der automatisierte Mehrfenster-Test bestätigt diese Vorsicht. Über BTC/SOL-Startpunkte `0`, `17000` und `34000` liegt Realwelt im Mittel höher bei Quellen- und Kernnähe, aber nicht jedes Fenster ist klar stärker. Die verfeinerte Lesung zeigt mehrere Unterformen: klare Realwelt-Kernnähe, Realnähe ohne Feldzeitvorsprung, realer Nachhall ohne Kernnähe und einzelne Nullnähe. Die anschließende Mehrasset-Prüfung mit BTC, SOL, DOGE, PAXG und XRP zeigt diese Zwischenlagen assetübergreifend: DOGE/PAXG tragen klare Kernnähe, DOGE/XRP spätere Kernnähe ohne Feldzeitvorsprung, BTC realen Nachhall ohne Kernnähe und SOL graduell gemischte positive Feldnähe. Daraus wurde eine passive Anschlussqualität in die Feldrollen-Memory aufgenommen: `kernnah`, `kernnah_ohne_feldzeit`, `nachhallnah_ohne_kern`, `offen_gemischt`, `nullnah` und `anschlussnah`. Die belastbare Aussage lautet deshalb: Reifungsrollen bleiben wiederlesbar, aber Realwelt/Nullwelt ist keine harte Grenze, sondern eine graduelle Feldqualität mit unterscheidbaren Zwischenlagen. Siehe [1841_MCM_FELDROLLEN_MEMORY_REPRO_2025.md](docs/befunde/1841_MCM_FELDROLLEN_MEMORY_REPRO_2025.md), [1842_MCM_FELDROLLEN_MEMORY_REPRO_2025_NULLKONTROLLE.md](docs/befunde/1842_MCM_FELDROLLEN_MEMORY_REPRO_2025_NULLKONTROLLE.md), [1843_MCM_FELDROLLEN_MEMORY_REPRO_2025_OFFSET_NULLKONTROLLE.md](docs/befunde/1843_MCM_FELDROLLEN_MEMORY_REPRO_2025_OFFSET_NULLKONTROLLE.md), [1844_MCM_FELDROLLEN_REIFUNG_ZWISCHENBILANZ.md](docs/befunde/1844_MCM_FELDROLLEN_REIFUNG_ZWISCHENBILANZ.md), [1845_MCM_FELDROLLEN_MEHRFENSTER_TEST.md](docs/befunde/1845_MCM_FELDROLLEN_MEHRFENSTER_TEST.md), [1846_MCM_FELDROLLEN_MEHRASSET_ZWISCHENLAGEN.md](docs/befunde/1846_MCM_FELDROLLEN_MEHRASSET_ZWISCHENLAGEN.md) und [1847_PASSIVE_FELDROLLEN_MEMORY_ANSCHLUSSQUALITAET.md](docs/befunde/1847_PASSIVE_FELDROLLEN_MEMORY_ANSCHLUSSQUALITAET.md).
